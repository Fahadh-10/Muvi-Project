...
open class PopularMoviesViewHolder(private val binding: MediaItemViewHolderBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    fun configureCell(
        ...
        val filteredList = homeList.filter { it.homeListingType == HomeList.HomeListType.POPULAR_MOVIES.name } as ArrayList<HomeList>
        binding.titleTV.text = HomeList.HomeListType.POPULAR_MOVIES.type
    ...
    companion object {
        fun getViewHolder(parent: ViewGroup): PopularMoviesViewHolder {
