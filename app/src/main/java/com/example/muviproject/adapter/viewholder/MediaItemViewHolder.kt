...
open class MediaItemViewHolder(private val binding: MediaItemViewHolderBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    fun configureCell(
        ...
        val filteredList = homeList.filter { it.homeListingType == HomeList.HomeListType.RECOMMENDED_MOVIES.name } as ArrayList<HomeList>
        binding.titleTV.text = HomeList.HomeListType.RECOMMENDED_MOVIES.type
    ...
    companion object {
        fun getViewHolder(parent: ViewGroup): MediaItemViewHolder {
